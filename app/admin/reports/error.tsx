    ...
    <div className="section">
      <div className="container">
        <div className="card">
          ...
          <h1 className="hero-title" style={{ fontSize: '2.2rem', marginTop: 12 }}>The producer report generator hit a server issue</h1>
          <p className="muted">
            This route is isolated so the rest of admin should stay up even if reporting fails. If it happens again, the digest below will help trace the exact production error.
          </p>
