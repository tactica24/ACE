    ...
    >
      ...
      <div className="stack-list">
        <AdminDisclosureSection
          title="Payout action board"
          description="Open the grouped payout queues only when you are actively processing transfers."
          badge="Queue"
          defaultOpen
        >
          <CreatorPayoutAdmin
        ...
        <AdminDisclosureSection
          title="Payout reference detail"
          description="Expand for producer wallet exposure and the payout status flow guide."
          badge="Reference"
        >
          <div className="grid">
            <div className="card">
