...
export async function POST(req: NextRequest) {
  ...
  if (action === 'DELETE_USER') {
    const [wallet, videos, unlocks, subscriptions, p2pTransfers, payments, referralLinks, familyLinks, tvPairings, supportTickets, watchHistory, streamSessions, offlinePackages, moderatorActions, supportActionsReceived, supportActionsPerformed, creatorContracts, creatorSettlements, creatorPayouts] = await Promise.all([
