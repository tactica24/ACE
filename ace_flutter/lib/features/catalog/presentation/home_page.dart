  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PremiumScaffold(
      ...
      body: titlesAsync.when(
        data: (titles) => _HomeContent(titles: titles),
...
class _HomeContent extends StatelessWidget {
  const _HomeContent({required this.titles});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        _CarouselSection(title: "Editor's choice", titles: editorsChoice),
      ],
    );
  }
}
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF18284A), Color(0xFF0E1524), Color(0xFF21172E)],
        ),
