  ...
  return [
    {
      ...
      body:
        `The Producer hereby grants ACE Studio the limited rights required to host, stream, market, and distribute the audiovisual content titled "${args.videoTitle}" through ACE Studio and its approved playback surfaces. The Producer retains ownership of the underlying intellectual property except for the distribution rights expressly granted in this Agreement.`
    },
    {
    ...
    },
    {
      ...
      body:
        'The Producer will deliver a technically suitable master, artwork, and metadata for platform publication. ACE Studio may format, feature, promote, subtitle, or package the Content for storefront visibility and viewer discovery, provided those actions do not alter the core work without approval.'
    },
    {
      title: 'IV. Producer Warranties',
      body:
