...
const envSchema = z.object({
  ...
  BUNNY_STREAM_READONLY_API_KEY: z.string().default(''),
  BUNNY_STREAM_PULL_ZONE: z.string().default(''),
  BUNNY_STREAM_PLAYER_HOST: z.string().default('player.mediadelivery.net'),
...
function loadEnv(): Env {
  ...
  const parsedEnv = envSchema.parse({
    ...
    BUNNY_STREAM_LIBRARY_ID: normalizeEnvValue(process.env.BUNNY_STREAM_LIBRARY_ID),
    BUNNY_STREAM_API_KEY: normalizeEnvValue(process.env.BUNNY_STREAM_API_KEY),
    BUNNY_STREAM_READONLY_API_KEY: normalizeEnvValue(process.env.BUNNY_STREAM_READONLY_API_KEY),
    BUNNY_STREAM_PULL_ZONE: normalizeEnvValue(process.env.BUNNY_STREAM_PULL_ZONE),
    BUNNY_STREAM_PLAYER_HOST: normalizeEnvValue(process.env.BUNNY_STREAM_PLAYER_HOST),
