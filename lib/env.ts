...
const envSchema = z.object({
  ...
  AKASH_API_BASE_URL: z.string().default('https://console-api.akash.network'),
  AKASH_API_KEY: z.string().default(''),
  AKASH_DEFAULT_DEPOSIT_USD: z.string().default('0.5'),
  AKASH_TRANSCODE_IMAGE: z.string().default('python:3.12-alpine'),
  AKASH_CALLBACK_SECRET: z.string().default(''),
  LIVEPEER_API_KEY: z.string().default(''),
  LIVEPEER_API_BASE_URL: z.string().default('https://livepeer.studio/api'),
...
function loadEnv(): Env {
  ...
  const parsedEnv = envSchema.parse({
    ...
    AKASH_API_BASE_URL: normalizeEnvValue(process.env.AKASH_API_BASE_URL),
    AKASH_API_KEY: normalizeEnvValue(process.env.AKASH_API_KEY),
    AKASH_DEFAULT_DEPOSIT_USD: normalizeEnvValue(process.env.AKASH_DEFAULT_DEPOSIT_USD),
    AKASH_TRANSCODE_IMAGE: normalizeEnvValue(process.env.AKASH_TRANSCODE_IMAGE),
    AKASH_CALLBACK_SECRET: normalizeEnvValue(process.env.AKASH_CALLBACK_SECRET),
    LIVEPEER_API_KEY: normalizeEnvValue(process.env.LIVEPEER_API_KEY),
    LIVEPEER_API_BASE_URL: normalizeEnvValue(process.env.LIVEPEER_API_BASE_URL),
